...
export default function HomeScreen() {
  ...
  return <SafeAreaView style={styles.safe}><ScrollView contentContainerStyle={styles.container}>
    <View style={styles.brand}><View style={styles.logo}><Text style={styles.logoText}>T</Text></View><Text style={styles.brandText}>TCG HUB</Text><Pressable onPress={() => router.push('/account')} style={styles.account}><Text style={styles.accountText}>{session ? (syncState === 'syncing' ? 'Sincronizando…' : 'Minha conta') : 'Entrar'}</Text></Pressable></View>
