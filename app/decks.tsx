...
export default function DecksScreen() {
  ...
  return <SafeAreaView edges={['bottom']} style={styles.safe}><ScrollView contentContainerStyle={styles.container} keyboardShouldPersistTaps="handled">
    <Text style={styles.eyebrow}>{tcg?.name}</Text><Text style={styles.title}>Deck Builder</Text><Text style={styles.description}>Monte listas pelo catálogo, pela sua coleção ou fotografando até 10 cartas.</Text>
